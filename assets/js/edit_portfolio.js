...
(function () {
    document.addEventListener("DOMContentLoaded", function () {
        ...
        async function displayRecord(searchTerm = null, selectedHeading = null) {
            ...
            try {
                const response = await fetch("search_portfolio_records.php", {
                    method: "POST",
                    headers: {
        ...
        editForm.addEventListener("submit", async function (event) {
            ...
            const response = await fetch("edit_update_portfolio.php", {
                method: "POST",
                body: formData,
            });
            ...
            if (response.ok) {
                ...
                console.log(result);
                // If the response has a "success" property and its value is true, clear the form and redirect
                if (result.success) {
                    // Clearing form fields and other cleanup operations
